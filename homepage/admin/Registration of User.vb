    ...
    Private Sub LoadAccounts()
        Try
            Using connn As New MySqlConnection(connString)
                ...
                Dim query As String = "SELECT id, username, lastname, name, role, acc_status FROM account WHERE acc_status='OFF'"
    ...
    Private Sub Approve_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Approve.Click
        If DataGridView1.CurrentRow IsNot Nothing Then
            ...
            Try
                Using connn As New MySqlConnection(connString)
                    connn.Open()
                    Dim updateQuery As String = "UPDATE account SET acc_status='ON' WHERE id=@id"
                    Dim appcmd As New MySqlCommand(updateQuery, connn)
                    appcmd.Parameters.AddWithValue("@id", selectedId)
